...
- GEOGRAPHIC ANCHOR: Mention each country or location ONCE — do not repeat it. Use plain names only: "Iran", "Lisbon", "New York". No descriptors. Just the name, once, move on.
