...
try:
    ...
    # Try to import memory reader, but continue without it if it fails
    try:
        from open_viking.memory_reader import MemoryReader
        memory_available = True
    except ImportError:
        print("⚠️  Memory reader not available, continuing without it")
        MemoryReader = None
...
llm = LLMInterface()
memory = MemoryReader() if memory_available else None
